...
$_nav = [
  'admin'=>[
    ...
    ['icon'=>'calendar-range',  'label'=>'Tahun Ajaran',  'href'=>'/academic-years'],
    ['s'=>'Akademik'],
    ...
    ['icon'=>'arrow-up-circle', 'label'=>'Kenaikan Kelas','href'=>'/promotions'],
    ['icon'=>'banknote',        'label'=>'Pembayaran SPP','href'=>'/spp'],
    ['s'=>'Sekolah'],
    ...
    ['icon'=>'message-circle',  'label'=>'Forum Diskusi', 'href'=>'/discussions'],
    ['s'=>'Akun'],
